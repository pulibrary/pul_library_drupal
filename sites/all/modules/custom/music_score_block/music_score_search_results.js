            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.number > 0) {
                        $.each(data.records, function(index, result) {
                            ...
                            if (result['fulltextavail'] == "Y") {
                                online_avail = "<div class='all-full-text'>" +
                                    icon_hint +
                                    '<a target="_blank" class="all-search-link full-text-link" href="' + result['full_text_link'] +
                        ...
                        $('#music_score_block-music_score_search_results h2').replaceWith(function() {
                        ...
                        $('#music_score_block-music_score_search_results h2 a').each(function(index, value) {
