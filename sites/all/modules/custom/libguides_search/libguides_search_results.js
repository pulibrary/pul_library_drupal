                ...
                success: function(data) {
                    ...
                    if (data.number > 0) {
                        ...
                        $.each(data.records, function(index, result) {
                            ...
                            items.push('<li class="'+ row_class +'"><h3><a title="' + result['title'] + '" href="' + result['url'] +'" target="_blank">' + result['title'] + '</a></h3><div class="libguide-description">' + result['description'] + '</div></li>');
