                    ...
                    if (data.number > 0) {
                      $.each(data.records, function(index, result) {
                          ...
                          $.each(data.records, function(index, result) {
                            ...
                            if (result['repository']) {
                                for(var i=0, len=result['repository'].length; i < len; i++){
                                    var author = author + "<div class='author'>" + result['repository'][i] + "</div>";
                                }
                            }
                        ...
                        $('#catalog_block-catalog_pulfalight_results h2').replaceWith(function() {
                            ...
                            return '<h2><a title="' + refine_hint + ' ' + data.number + ' total results." href="' + data.more + '"><i class="icon-archives"></i>NEW Library Archives</a></h2>';
                        });
                        if (data.number > 3) {
