 ...
 *
 * Available variables:
 * - $class: A set of classes assigned to the video tag (if any).
 ...
 */
?>
<video contenteditable="false" controls<?php print $class ? ' class="' . $class . '"' : '' ?>>
  <source src="<?php print $url; ?>" type="<?php print $mime; ?>">
  <?php print t('Your browser does not support embedding video.') ?>
</video>
