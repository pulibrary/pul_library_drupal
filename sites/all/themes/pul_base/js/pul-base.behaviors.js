    ...
    attach: function (context) {
      ...
      if (l_staff > 2) {
        $('.page-find-all-results #general_site_user_search-panel_pane_1 h2').replaceWith(function() {
            return '<h2><a href="' + href_staff + '"><i class="icon-staff"></i>Library Staff Results</a></h2>';
        });
      } else {
      }
      //site search
      ...
      if(l_site > 2) {
        $('.page-find-all-results #general_site_keyword_search-panel_pane_1 h2').replaceWith(function() {
            return '<h2><a href="' + href_website + '"><i class="icon-windows"></i>Library Website Results</a></h2>';
        });
      } else {
      }
      // databases search
      ...
      if(l_db > 2) {
        $('.page-find-all-results #databases_keyword_search-panel_pane_2 h2').replaceWith(function() {
          return '<h2><a href="' + href_databases + '"><i class="icon-databases"></i>Databases Results</a></h2>';
      });
      } else {
      }
